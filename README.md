...
- Updated base structure from Android Studio.  
- Available in **Groovy DSL** and **Kotlin DSL**, clearly organized.  

### 🎮 libGDX Game Project  
- Includes the latest version of **libGDX**.  
- Configured with the **Gradle and AGP** required by the framework.  

### ⚙️ Android Native C++ Templates  
- Configured with **Default Toolchain**.  
- Compatible from **API Level 21** in both **Groovy DSL** and **Kotlin DSL**.  
- Can be adjusted to **API Level 16** in `app/build.gradle` (will only show a warning).  
...
- Templates using **Groovy DSL**.  
- Templates using **Kotlin DSL**.  
- **libGDX** framework templates.  
- **Native C++** project templates.  
- Each folder contains **.zip** and **uncompressed** versions.  

---

## 🤝 Contributing  

This repository is intended as an **open and collaborative resource**.  
